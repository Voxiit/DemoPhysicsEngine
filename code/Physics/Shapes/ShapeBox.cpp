...
/*
====================================================
ShapeBox::Support - return the vertex of the shape thatr is the furthest in that direction
====================================================
*/
...
Mat3 ShapeBox::InertiaTensor() const {
	// Intertia tensor for box centered around zero
	...
	// Now we need top use the parallel axis theorem to get the inertia tensor for a box
	// that is not center around the origin
	Vec3 cm;
