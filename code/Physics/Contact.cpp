...
void ResolveContact( contact_t & contact ) 
{
	...
	//
	// Calculate the impulse cause by friction
	//
	...
	// Find the tangeant direction of the velocity with respect to the normal of the collision
	const Vec3 velTang = vab - velNorm;

	// Get the tangeantial velocities relatives to the other body
	...
	// Calcul the tangential impulse for friction
